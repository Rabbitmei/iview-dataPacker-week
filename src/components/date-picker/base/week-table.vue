...
<script>
    import { getFirstDayOfMonth, getDayCountOfMonth ,getWeekNumber,getWeekMinMax} from '../util';
...
//                    });
        ...
        computed: {            
            ...
            headerDays () {
                ...
                // console.log(this.t('i.datepicker.weekStartDay'))
        ...
        methods: { 
            handleClick (cell) {
                ...
                } else if(this.selectionMode === 'week' && this.week && this.week !== 'undefined') {
                    this.rangeState.selecting = false;
                    // console.log({minDate: this.minDate, maxDate})
                    let minDate = getWeekMinMax(newDate,0)
                    let maxDate = getWeekMinMax(newDate,6)
                   
                    this.$emit('on-pick', {minDate, maxDate ,'index': cell.weekIndex});  
                }else{
            ...
            getCellCls (cell) {
                return [
                    `${prefixCls}-cell`,
                    {
                        ...
                        [`${prefixCls}-cell-week-p`]: cell.type === 'week-p',
...
<style>
    ...
    .ivu-date-picker-cells-cell-week-p{
        color:#f00;
    }
