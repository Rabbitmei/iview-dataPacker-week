...
<script>
    ...
    import { formatDate, parseDate ,getWeekMinMax} from './util';
    ...
    const RANGE_FORMATTER = function(value, format) {
     ...
     const RANGE_FORMATTERWEEK = function(value, format) {
    ...
    const RANGE_PARSERWEEK = function(text, format) {
    ...
    const TYPE_VALUE_RESOLVER_MAP = {
        ...
        week: {
            formatter: RANGE_FORMATTERWEEK,
            parser: RANGE_PARSERWEEK
        },
        time: {
            formatter: DATE_FORMATTER,
            parser: DATE_PARSER
...
//                if (!this.disableClickOutSide) this.visible = false;
            ...
            emitChange (date) {
                ...
                this.$emit('on-change', newDate, weekIndex);
                this.$nextTick(() => {
